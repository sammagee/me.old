    ...
    <main className="flex items-center justify-center min-h-screen w-full">
      ...
      <header className="fixed flex items-center justify-between left-0 right-0 top-0 p-8 z-10">
        ...
        <div className="flex flex-1 items-center justify-end">
          <a className="bg-gray-800 p-4 rounded-full rise" href="https://github.com/sammagee">
            <svg class="text-gray-500 h-6 w-6" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
